...
public class AdminUpdatePassFrame extends JFrame implements ActionListener {
    ...
    public AdminUpdatePassFrame(User u) {
        ...
        this.redColor = new Color(77, 25, 21);
        ...
        if (command.equals("Update Password")) {
            ...
            if (!u.getPassword().equals(oldPass)) {
              ...
              { 
                ...
                {
                  messageLabel.setText("Error: User is not an Admin.");
                }
